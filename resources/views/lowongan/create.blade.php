            ...
            <div class="card mb-3">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control form-control-sm" id="deskripsi" name="deskripsi" rows="3">{{ old('deskripsi') }}</textarea>
                    </div>
                ...
                <div class="card-footer">
                    ...
                    <a href="{{ route('lowongan.index') }}" class="btn btn-sm btn-secondary"><i class="fas fa-times mr-2"></i>
                        Batal</a>
                </div>
            </div>
        </form>
