...
return [
  ...
  'password' => [
    ...
    'mixed' => 'Kata sandi harus memiliki huruf besar dan huruf kecil.',
    'numbers' => 'Kata sandi harus mengandung setidaknya satu angka.',
    'symbols' => 'Kata sandi harus mengandung setidaknya satu simbol (misalnya @, $, !, %).',
    'uncompromised' => 'Kata sandi ini pernah bocor dalam kebocoran data. Silakan pilih yang lain.',
    'throttled' => 'Terlalu banyak percobaan. Silakan coba lagi dalam beberapa detik.',
  ],
